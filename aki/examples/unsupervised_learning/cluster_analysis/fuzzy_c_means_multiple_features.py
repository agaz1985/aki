...
def main(parameters):
    ...
    start = time.time()
    sk_centroids, _, _, _, _, _, _ = fuzz.cluster.cmeans(cluster_data,
    ...
    ax[0].set_title(f"Test data: {n_points} points x {parameters['n_clusters']} clusters. [skfuzzy ~{sk_time} ms.]")
